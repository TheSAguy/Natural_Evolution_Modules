...
if not NE_Enemies.Settings.NE_Remove_Vanilla_Spawners then
	...
	table.insert(data.raw["unit-spawner"]["spitter-spawner"].result_units, {"small-spitter-Mk2", 	{{0.15, 0.0}, {0.45, 0.3}, {0.55, 0.0}}})
	table.insert(data.raw["unit-spawner"]["spitter-spawner"].result_units, {"small-spitter-Mk3", 	{{0.25, 0.0}, {0.55, 0.3}, {0.65, 0.0}}})
	table.insert(data.raw["unit-spawner"]["spitter-spawner"].result_units, {"medium-spitter-Mk2", 	{{0.45, 0.0}, {0.75, 0.3}, {0.85, 0.0}}})
	table.insert(data.raw["unit-spawner"]["spitter-spawner"].result_units, {"medium-spitter-Mk3", 	{{0.55, 0.0}, {0.85, 0.3}, {0.95, 0.0}}})
	table.insert(data.raw["unit-spawner"]["spitter-spawner"].result_units, {"big-spitter-Mk2",	 	{{0.75, 0.0}, {1.00, 0.3}}})
	table.insert(data.raw["unit-spawner"]["spitter-spawner"].result_units, {"big-spitter-Mk3", 	{{0.85, 0.0}, {1.00, 0.3}}})
