...
subEnemyNumberTable["ne_green_splash_1"][0] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)    
subEnemyNumberTable["ne_green_splash_1"][1] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)   
subEnemyNumberTable["ne_green_splash_1"][2] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)    
subEnemyNumberTable["ne_green_splash_1"][3] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2) 
subEnemyNumberTable["ne_green_splash_1"][4] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)  
subEnemyNumberTable["ne_green_splash_1"][5] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)  
subEnemyNumberTable["ne_green_splash_1"][6] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)
subEnemyNumberTable["ne_green_splash_1"][7] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)
subEnemyNumberTable["ne_green_splash_1"][8] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)    
subEnemyNumberTable["ne_green_splash_1"][9] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)   
subEnemyNumberTable["ne_green_splash_1"][10] =			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)    


--- Worm Unit-Launcher
subEnemyNumberTable["ne_green_splash_2"] = {}
subEnemyNumberTable["ne_green_splash_2"][0] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)    
...
subEnemyNumberTable["ne_green_splash_2"][3] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2) 
subEnemyNumberTable["ne_green_splash_2"][4] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)  
subEnemyNumberTable["ne_green_splash_2"][5] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)  
subEnemyNumberTable["ne_green_splash_2"][6] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)
subEnemyNumberTable["ne_green_splash_2"][7] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)
subEnemyNumberTable["ne_green_splash_2"][8] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)    
subEnemyNumberTable["ne_green_splash_2"][9] = 			math.floor(1 + NE_Enemies.Settings.NE_Difficulty / 2)   
subEnemyNumberTable["ne_green_splash_2"][10] =			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)    
...
subEnemyNumberTable["Spawner-Breeder"][3] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2) 
subEnemyNumberTable["Spawner-Breeder"][4] = 			math.floor(3 + NE_Enemies.Settings.NE_Difficulty / 2)  
subEnemyNumberTable["Spawner-Breeder"][5] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)  
subEnemyNumberTable["Spawner-Breeder"][6] = 			math.floor(3 + NE_Enemies.Settings.NE_Difficulty / 2)
subEnemyNumberTable["Spawner-Breeder"][7] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)
subEnemyNumberTable["Spawner-Breeder"][8] = 			math.floor(3 + NE_Enemies.Settings.NE_Difficulty / 2)    
subEnemyNumberTable["Spawner-Breeder"][9] = 			math.floor(2 + NE_Enemies.Settings.NE_Difficulty / 2)   
subEnemyNumberTable["Spawner-Breeder"][10] =			math.floor(3 + NE_Enemies.Settings.NE_Difficulty / 2)    
