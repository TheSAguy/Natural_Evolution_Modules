data.raw["unit-spawner"]["bob-biter-spawner"].result_units = (function()
                     local res = {}
                       ...
                       res[8] = {"bob-bigger-biter",  	{{0.70, 0.0}, {1.00, 0.1}}}	
					   res[9] = {"bob-biggest-biter",	 {{0.80, 0.0}, {1.00, 0.2}}}	
					   res[10] = {"bob-fire-biter",  	{{0.90, 0.0}, {1.00, 0.3}}}		
					   
					   res[11] = {"behemoth-biter",  	{{0.95, 0.0}, {1.00, 0.2}}}					   			   
...
data.raw["unit-spawner"]["bob-spitter-spawner"].result_units = (function()
                     local res = {}
                       ...
                       res[9] = {"bob-bigger-spitter", {{0.75, 0.0}, {1.00, 0.1}}}
					   res[10] = {"bob-biggest-spitter",{{0.85, 0.0}, {1.00, 0.2}}}
					   res[11] = {"bob-poison-spitter",	{{0.90, 0.0}, {1.00, 0.3}}}
					   
					   res[12] = {"behemoth-spitter",  	{{0.95, 0.0}, {1.00, 0.2}}}				
