...
if data.raw["item"]["bob-sniper-turret-1"] ~= nil and data.raw["car"]["bob-tank-2"] ~= nil  or mods["bobwarfare"] then
...
--Detect N.E. Enemies
if data.raw["unit"]["small-biter-Mk2"] ~= nil or data.raw["unit"]["small-spitter-Mk2"] ~= nil or mods["Natural_Evolution_Enemies"] then
...
if data.raw["recipe"]["concussion-turret"] ~= nil or data.raw["item"]["cannon-turret"] ~= nil or mods["EndgameCombat"] then
