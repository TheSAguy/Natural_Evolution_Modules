...
table.insert(data.raw.technology["artillery-shell-speed-1"].effects,{type = "gun-speed", ammo_category = "Bio_Cannon_Ammo", modifier = 1})
		
table.insert(data.raw.technology["weapon-shooting-speed-5"].effects,{type = "gun-speed", ammo_category = "Bio_Cannon_Ammo", modifier = 0.8})
table.insert(data.raw.technology["weapon-shooting-speed-6"].effects,{type = "gun-speed", ammo_category = "Bio_Cannon_Ammo", modifier = 1.5})
